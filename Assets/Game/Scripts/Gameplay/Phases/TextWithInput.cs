...
namespace Phases
{
    public class TextWithInput : Letter
    {
        ...
        [SerializeField] private TMP_InputField mainInputField; //Used in the prefabs

        public static InputPhase owner;

        public static void SetOwner(InputPhase on)
        {
            owner = on; //It's static, but it could be private only 
        }
