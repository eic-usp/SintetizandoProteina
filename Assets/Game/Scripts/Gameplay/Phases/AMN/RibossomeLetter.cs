...
/*
    No matter what changes, Ball = childCount -1. If that is correct them everything will work fine
*/
...
namespace Phases.AMN
{
    public class RibossomeLetter : Letter
    {
        ...
        public int GetStateRib() => this.stateRib;

        public void SetStateRib(int stateRib) { this.stateRib = stateRib; }

        public Color GetRibossomeColor() => this.elemColor;

        public bool GetAMNPresence() => withAMN;
